...
print(jwt.encode({'sub':a.sub,'role':a.role,'exp':datetime.now(timezone.utc)+timedelta(hours=8)},os.getenv('JWT_SECRET','dev-secret'),algorithm=os.getenv('JWT_ALGORITHM','HS256')))
